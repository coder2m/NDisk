...
type UserInfo struct {
	...
	EmailStatus          uint32   `protobuf:"varint,8,opt,name=email_status,json=emailStatus,proto3" json:"email_status,omitempty"`
	...
	DeletedAt            uint64   `protobuf:"varint,12,opt,name=deleted_at,json=deletedAt,proto3" json:"deleted_at,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *UserInfo) GetAuId() uint32 {
	if m != nil {
		return m.AuId
	}
	return 0
...
var fileDescriptor_70be6522ed124f25 = []byte{
	...
	,
}
...
type NUserServiceClient interface {
	...
	// 获取机构下的所有用户
	ListUserByJoinAgency(ctx context.Context, in *Id, opts ...grpc.CallOption) (*UserList, error)
	// 修改关联表状态
...
func (c *nUserServiceClient) ListUserByJoinAgency(ctx context.Context, in *Id, opts ...grpc.CallOption) (*UserList, error) {
	out := new(UserList)
...
type NUserServiceServer interface {
	...
	// 获取机构下的所有用户
	ListUserByJoinAgency(context.Context, *Id) (*UserList, error)
	// 修改关联表状态
...
func (*UnimplementedNUserServiceServer) ListUserByJoinAgency(ctx context.Context, req *Id) (*UserList, error) {
